            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
              ...
              {!isLoggedIn && (
                <a
                  ...
                  className="inline-flex items-center gap-2.5 text-sm font-black px-6 py-3.5 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] hover:bg-[var(--color-surface-hover)] text-[var(--color-foreground)] transition-all hover:scale-[1.01] active:scale-[0.98] shadow-md group"
                >
